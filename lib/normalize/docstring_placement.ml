...
let include_infos x =
  ...
  then { x with pincl_pre_doc = x.pincl_post_doc; pincl_post_doc = None }
  else x
;;
...
let value_binding x =
  ...
  then { x with pvb_pre_doc = x.pvb_post_doc; pvb_post_doc = None }
  else x
;;

let module_binding x =
  if Option.is_none x.pmb_pre_doc && Option.is_some x.pmb_post_doc
  then { x with pmb_pre_doc = x.pmb_post_doc; pmb_post_doc = None }
  else x
;;
