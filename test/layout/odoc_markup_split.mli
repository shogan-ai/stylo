(** Same content as odoc markup, but with commentds/docstrings split in smaller
    chunks so they get parsed and rendered independently.
    This allows us to test actual markup rendering more. *)
